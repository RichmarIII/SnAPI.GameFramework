...
namespace SnAPI::GameFramework::Detail
{
    ...
    struct ProjectBuildIntegrationLayout
    {
        ...
        std::filesystem::path ProjectCodeRootCMakePath{}; /**< @brief Checked-in `Code/CMakeLists.txt` bridge file. */
        std::filesystem::path
    ...
    /**
     * @brief Build one generic workspace `Code/CMakeLists.txt` bridge file.
