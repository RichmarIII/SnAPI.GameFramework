 ...
 * @brief Umbrella header for the core runtime reflection facilities used by GameFramework.
 *
 ...
 *
 * This header is intended as the "just give me reflection" include for users who do not
 * want to track the lower-level reflection headers individually.
 */
