    ...
    namespace
    {
        ...
        [[nodiscard]] bool IsGameFrameworkSourceRoot(const std::filesystem::path& Directory)
        {
            ...
            return std::filesystem::exists(Directory / "CMakeLists.txt") &&
                   std::filesystem::exists(Directory / "Modules" / "GameFramework" / "Public" / "GameFramework.hpp") &&
                   std::filesystem::exists(Directory / "Modules" / "GameFramework" / "Private" / "GameFramework.cpp");
        }
